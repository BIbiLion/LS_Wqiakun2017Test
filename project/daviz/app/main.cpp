...
static void printVersion(const PluginSpec *coreplugin)// spec 插件规格说明
{
    QString version;
...
int main(int argc, char **argv)//学习
{
    ...
    // Load  加载插件
    const QStringList pluginPaths = getPluginPaths();// 插件的目录    ./plugins

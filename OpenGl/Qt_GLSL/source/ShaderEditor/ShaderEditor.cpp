 ...
 * ┃ create date: 2013年8月21日星期三 23时17分38秒                          ┃
...
/*---------------------------------------------------------------------------*/
ShaderEditor::ShaderEditor( QWidget* pParent ):
    QPlainTextEdit( pParent )
{
    new ShaderKeywordHighlight( document( ) );
}
/*---------------------------------------------------------------------------*/
void ShaderEditor::keyPressEvent( QKeyEvent* pEvent )
{
    if ( pEvent->key( ) == Qt::Key_Tab )
    {
        textCursor( ).insertText( "    " ); return;// 按下TAB键插入四个空格
    }

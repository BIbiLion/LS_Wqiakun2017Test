...
macro(_populate_Ftp_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Ftp_install_prefix}/bin/${LIB_LOCATION}")
    ...
    set(imported_implib "${_qt5Ftp_install_prefix}/lib/${IMPLIB_LOCATION}")
    _qt5_Ftp_check_file_exists(${imported_implib})
...
if (NOT TARGET Qt5::Ftp)
    ...
    _populate_Ftp_target_properties(RELEASE "Qt5Ftp.dll" "libQt5Ftp.a" )



    _populate_Ftp_target_properties(DEBUG "Qt5Ftpd.dll" "libQt5Ftpd.a" )

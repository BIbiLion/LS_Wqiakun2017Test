...
int main()
{
    ...
    Format font_vertical;//竖排文字
    font_vertical.setRotation(255);//255
    ...
    xlsx.addSheet("NumFormats");//numformat index && selfDefine
